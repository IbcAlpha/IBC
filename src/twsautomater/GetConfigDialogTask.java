...
class GetConfigDialogTask implements Callable<JDialog>{
    ...
    @Override
    public JDialog call() throws TwsAutomaterException, InterruptedException {
        ...
        if (isGateway) {
            if (!Utils.invokeMenuItem(mainForm, new String[] {"Configure", "Settings"})) throw new TwsAutomaterException("'Configure > Settings' menu item");
            ...
            throw new TwsAutomaterException("'Edit > Global Configuration' or 'File > Global Configuration' menu items");
        }
