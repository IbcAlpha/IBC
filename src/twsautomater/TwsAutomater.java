 ...
 * TwsAutomater is a class whose main starts up the TWS or Gateway application, and which
...
public class TwsAutomater {
     ...
     *                    directory in a file called "TwsAutomater.ini".
	 *    If length == 2 and args[0] is "encrypt", we print out the encryption of args[1].
     * @throws java.lang.Exception
     */

    private TwsAutomater() { }
    
    public static void main(final String[] args) throws Exception {
        if (Thread.getDefaultUncaughtExceptionHandler() == null) {
            Thread.setDefaultUncaughtExceptionHandler(new twsautomater.UncaughtExceptionHandler());
        }
        checkArguments(args);
