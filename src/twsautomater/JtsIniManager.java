...
class JtsIniManager {
    ...
    * prevents TwsAutomater properly handling the StoreSettingsOnServer ini file
    * option.
    * 
    ...
    * TwsAutomater doesn't expect, and it can't find the trading mode selector.
    *
    * [IBGateway]
    * ApiOnly=true
    *
    * To avoid these problems, TwsAutomater ensures that a jts.ini exists which 
